...
Run the validation gates the project's CLAUDE.md declares. Commands must actually execute and pass. Resolve every warning and failure, including prior failures. An infrastructure error is blocking, not a pass.
