...
Read `./claude-workers.md` for the native Agent schema, checkpoint/continuation protocol and local-worktree capability checks. Read `./cloud.md` for cloud deployment. Remote cloud-session creation is a different transport, not an interchangeable worker call.
