...
Diff `implement/[CARD_ID]/baseline..HEAD`, then read the card (and plan, if any) again with that diff in hand. If you implemented this yourself or the diff is large, dispatch a fresh-eyes subagent per angle.
