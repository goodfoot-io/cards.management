...
Run lint and typecheck plus each package suite the `implement/[TASK_KEY]/baseline..HEAD` diff touches (or the plan's validation commands, when following a plan).
