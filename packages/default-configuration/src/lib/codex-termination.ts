/**
 * Bounded termination for a stable, launcher-owned Codex process tree.
 * @summary Stable Codex process-tree termination
 * @module
 */
...
export type CodexTerminationResult = OwnedTreeTerminationResult;
export type CodexTerminationReason = 'cancel' | 'shutdown';
export interface CodexTerminationOptions extends OwnedTreeTerminationOptions {
...
export interface CodexTerminationController {
  terminate(reason: 'cancel' | 'shutdown'): Promise<CodexTerminationResult>;
}
