/**
 * Bounded termination for a stable, launcher-owned Claude process tree.
 * @summary Stable Claude process-tree termination
 * @module
 */
...
export type ClaudeTerminationResult = OwnedTreeTerminationResult;
export type ClaudeTerminationReason = 'cancel' | 'shutdown';
export interface ClaudeTerminationOptions extends OwnedTreeTerminationOptions {
...
export interface ClaudeTerminationController {
  terminate(reason: 'cancel' | 'shutdown'): Promise<ClaudeTerminationResult>;
}
