/**
 * The four delivery classes and their acceptance and replay semantics.
 *
 ...
 * invent its own answer, which is how a replayed durable intent could perform
 * a destructive effect twice.
 *
...
/** The four delivery classes, in the order the protocol contract lists them. */
