/**
 * Tests for the Claude Notification(idle_prompt) shutdown-drain readiness hook.
 *
 * @summary Tests for the Claude Notification(idle_prompt) shutdown-drain readiness hook
 */
...
import hook from '../../../src/claude/runtime/notification-shutdown-drain.js';
...
const input = { session_id: 'session-456', notification_type: 'idle_prompt' } as Parameters<typeof hook>[0];
...
describe('Claude Notification(idle_prompt) shutdown-drain hook', () => {
